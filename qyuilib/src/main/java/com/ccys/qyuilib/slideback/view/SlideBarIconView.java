 ...
 * 侧滑返回的图标
 */
public class SlideBarIconView extends View {
    ...
    public SlideBarIconView(Context context) {
        this(context, null);
    }

    public SlideBarIconView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideBarIconView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
