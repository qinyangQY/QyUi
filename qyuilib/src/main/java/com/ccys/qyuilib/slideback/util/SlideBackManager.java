...
import com.ccys.qyuilib.slideback.view.SlideBackInterceptLayout;
import com.ccys.qyuilib.slideback.view.SlideBarIconView;
...
public class SlideBackManager {
    ...
    public SlideBackManager register(Activity activity, boolean haveScroll, SlideBackCallBack callBack) {
        ...
        slideBackIconView = new SlideBarIconView(activity);
     ...
     * @param position 触点位置
     */
    private void setSlideBackPosition(SlideBarIconView view, int position) {
