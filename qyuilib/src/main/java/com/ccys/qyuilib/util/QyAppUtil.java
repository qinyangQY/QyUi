...
public class QyAppUtil {
    ...
    public static String getImagePath() {
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext()) + "/image";
    }

    public static String getFilePath() {
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext()) + "/file";
    }

    public static String getVideoPath() {
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext()) + "/video";
    }

    public static String getVoicePath() {
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext()) + "/voice";
    }

    public static String getCachePath() {
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext()) + "/cache";
    }
    public static String getAppFilePath(){
        return QyBaseApplication.getContext().getExternalCacheDir().getAbsolutePath() + "/" + getAppPackageName(QyBaseApplication.getContext());
    }
    //创建app运行所需的必要文件路径
    public static void createFilePath() {
        if (!(new File(getImagePath())).exists()) {
            if (!(new File(getImagePath()).isDirectory())) {
                (new File(getImagePath())).mkdirs();
            }
        }
    ...
    public static void cleanAppFileCache(Context context) {
        deleteDirWihtFile(context, new File(getImagePath()));
